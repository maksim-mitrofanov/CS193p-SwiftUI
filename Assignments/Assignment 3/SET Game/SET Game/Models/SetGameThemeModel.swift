...
struct SetGameThemeModel {
    private static func getBaseColor(for card: SetCardModel) -> UIColor {
    ...
    private static func getForegroundColor(for card: SetCardModel) -> UIColor {
    ...
    private static func getStrokeColor(for card: SetCardModel) -> UIColor {
        let cardColor = getBaseColor(for: card)
    ...
    private static func getTitle(for card: SetCardModel) -> String {
    ...
    static func getAttributedTitle(for card: SetCardModel) -> NSMutableAttributedString {
        ...
        let cardTitleAttributes: [NSAttributedString.Key : Any] = [
            ...
            .strokeWidth: -5,
            .foregroundColor : SetGameThemeModel.getForegroundColor(for: card)
        ]
